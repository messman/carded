import { Card, Rank, SpecialRank, Suit } from '../../models';
import { Dad2020CardDesign, LyricFontSizeFactor } from './shared';

export const cards: Card<Dad2020CardDesign>[] = [
	/*
		Ace: Aerosmith
	...
	*/
	...createForArtist(Rank.ace, ['Aerosmith'], [
		{
			...
			lyricsSizeFactor: LyricFontSizeFactor.larger,
	...
	...createForArtist(Rank.two, ['Bruce Springsteen'], [
		...
		},
		{
			...
			lyricsSizeFactor: LyricFontSizeFactor.smaller,
	...
	{
		mark: {
			specialRank: SpecialRank.joker1
		},
		skip: false,
		design: {
			artistLines: ['Boston'],
	...
	{
		mark: {
			specialRank: SpecialRank.joker2
		},
		skip: false,
		design: {
			artistLines: ['Boston'],
...
interface DesignWithoutArtist extends Omit<Dad2020CardDesign, 'artistLines'> {
	skip: boolean;
}

function createForArtist(rank: Rank, artistLines: string[], designs: DesignWithoutArtist[]): Card<Dad2020CardDesign>[] {
